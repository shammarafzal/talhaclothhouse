...
class _AllSuppliersBalanceScreenState
  ...
  Future<void> _loadSuppliersWithBalance() async {
    try {
      ...
      for (final sDoc in supplierSnap.docs) {
        ...
        if (remainingForSupplier < 0) {
          remainingForSupplier = 0; // just in case
        }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Suppliers – Total Remaining"),
        centerTitle: true,
      ),
      body: Container(
          ...
          children: [
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  Text(
                    supplier.name.isEmpty ? "Unnamed Supplier" : supplier.name,
                    style: const TextStyle(
                      fontWeight: FontWeight.w600,
                      fontSize: 16,
                    ),
                  ...
                  Text(
                    "Total Remaining: ${rem.toStringAsFixed(2)}",
                    style: TextStyle(
                      color: remColor,
